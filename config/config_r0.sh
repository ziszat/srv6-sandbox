...
ifconfig enp0s8 up
ip addr add 10.0.114.1/24 dev enp0s8

ifconfig enp0s9 up
ip -6 addr add 2001:b::1/64 dev enp0s9

ifconfig enp0s10 up
ip -6 addr add 2001:10::1/64 dev enp0s10
...
ip -6 route add fc00:f::a/128 encap seg6local action End.DX4 nh4 10.0.114.2 dev enp0s8
