...
ifconfig eth1 up
ip -6 addr add 2001:25::2/64 dev eth1

ifconfig eth2 up
ip -6 addr add 2001:35::2/64 dev eth2

ifconfig eth3 up
ip -6 addr add 2001:56::1/64 dev eth3
...
ip -6 route add fc00:2::/64 via 2001:25::1
ip -6 route add fc00:3::/64 via 2001:35::1
ip -6 route add fc00:6::/64 via 2001:56::2
ip -6 route add fc00:66::/64 via 2001:56::2
ip -6 route add 2001:b::/64 via 2001:35::1
...
ip -6 route add fc00:5::a/128 encap seg6local action End dev eth3
# ip -6 route add fc00:22::a/128 encap seg6local action End dev eth2
