...
ifconfig enp0s8 up
ip -6 addr add 2001:25::2/64 dev enp0s8

ifconfig enp0s9 up
ip -6 addr add 2001:35::2/64 dev enp0s9

ifconfig enp0s10 up
ip -6 addr add 2001:56::1/64 dev enp0s10
...
ip -6 route add fc00:5::a/128 encap seg6local action End dev enp0s10
